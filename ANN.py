...
def train_ann_model():
    ...
    accuracy, f1, roc_auc, cm = evaluate_classifier(ann_model, X_test_scaled, y_test)
...
if __name__ == "__main__":
    model, scaler, expected_columns_order, accuracy, f1, roc_auc, cm = train_ann_model()
    print(f"ANN trained. Test Accuracy: {accuracy:.2f}%  F1: {f1:.3f}  ROC-AUC: {roc_auc:.3f}")
